# 🚀 START HERE - Daily Workflow Guide

## Quick Start

This is your **daily command center**. Use these prompts every day to keep everything organized.
...
### ✅ LOCKED (Don't Modify)
- **SOP/** - All project planning docs (reference only)
  - Technical roadmap, features, design, etc.
  - These are the source of truth

### 📝 LIVE (Update Daily)
- **docs/DAILY_LOGS/** - Your daily progress logs
- **docs/DECISIONS/** - Architecture decisions (ADRs)
- **docs/ISSUES/** - Bug tracking and solutions
- **docs/PROGRESS.md** - High-level progress
...
For issues, decisions, status checks, and weekly reviews, see:
**[DAILY_PROMPTS.md](./DAILY_PROMPTS.md)** - Complete list of all prompts
