...
export function BillchopAnalyticsScreen({ onBack }: BillchopAnalyticsScreenProps) {
  const { token } = useAuth();
  ...
  async function loadData() {
    ...
    try {
      ...
      const [spendingData, trendsData] = await Promise.all([
        ...
        getExpenseMonthlyTrends(token, 6),
      ]);
      setSpendingByCategory(spendingData);
      setMonthlyTrends(trendsData);
    } catch (err) {
      setError(err instanceof Error ? err.message : 'Failed to load Billchop analytics data');
    } finally {
      setLoading(false);
      setRefreshing(false);
    }
    ...
    return (
      <SafeAreaView style={styles.safeArea} edges={['top', 'left', 'right']}>
        <View style={styles.loadingContainer}>
          ...
          <Text style={styles.loadingText}>Loading Billchop analytics...</Text>
        </View>
      </SafeAreaView>
    );
  }
      ...
      >
        <View style={styles.content}>
          <View style={styles.header}>
            ...
            <Text style={styles.title}>Billchop Analytics</Text>
            ...
            {spendingByCategory.length === 0 ? (
              <View style={styles.emptyChartContainer}>
                ...
                <Text style={styles.emptyChartSubtext}>
                  Add split expenses to see your spending breakdown
                </Text>
              </View>
            ) : (
              <>
          ...
          <View style={styles.section}>
            ...
            {monthlyTrends.length === 0 ? (
              <View style={styles.emptyChartContainer}>
                ...
                <Text style={styles.emptyChartSubtext}>
                  Add split expenses to see your spending trends
                </Text>
              </View>
            ) : (
              <>
                ...
                <View style={styles.trendSummary}>
                  <View style={styles.trendSummaryItem}>
                    <Text style={styles.trendSummaryLabel}>Avg Monthly</Text>
                  ...
                  <View style={styles.trendSummaryItem}>
                    <Text style={styles.trendSummaryLabel}>Total</Text>
                    <Text style={styles.trendSummaryValue}>
                      {formatCurrency(monthlyTrends.reduce((sum, t) => sum + t.amount, 0))}
                    </Text>
                  </View>
                </View>
