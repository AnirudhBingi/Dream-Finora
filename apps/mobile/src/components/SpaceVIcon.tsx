 ...
 */
export function SpaceVIcon({ size = 24, color = '#FFFFFF', active = false }: SpaceVIconProps) {
  const iconSize = size;
  ...
  return (
    <View style={[styles.container, { width: iconSize, height: iconSize }]}>
      ...
      >
        <Defs>
          <LinearGradient id="spaceVGradient" x1="0%" y1="0%" x2="100%" y2="100%">
            <Stop offset="0%" stopColor={color} stopOpacity="1" />
            <Stop offset="100%" stopColor={color} stopOpacity={active ? "0.8" : "0.6"} />
          </LinearGradient>
        </Defs>
