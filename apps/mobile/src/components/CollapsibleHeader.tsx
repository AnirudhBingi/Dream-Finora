...
interface CollapsibleHeaderProps {
  ...
  onSpacerHeightChange?: (spacerHeight: Animated.AnimatedInterpolation<number>) => void;
}
 ...
 * ```
 */
export function CollapsibleHeader({ children, scrollY, headerHeight, headerTranslateY: externalTranslateY, onHeaderTranslateYChange, onSpacerHeightChange }: CollapsibleHeaderProps) {
...
export function getSpacerHeightInterpolation(headerTranslateY: Animated.Value, totalHeaderHeight: number) {
