...
const styles = StyleSheet.create({
  container: {
    flex: 1,
    position: 'relative',
    backgroundColor: '#F4F7F6', // Base background to prevent black screen
  },
  previousScreen: {
    position: 'absolute',
    top: 0,
    ...
    bottom: 0,
    zIndex: 0,
    backgroundColor: '#F4F7F6', // Ensure background color matches
  },
  currentScreen: {
    flex: 1,
    zIndex: 1,
    backgroundColor: '#F4F7F6', // Ensure background color
  },
});
