 ...
 */
export function getChoreCategoryIcon(category: string | null | undefined): string {
 ...
 */
export function getChoreCategoryMaterialIcon(category: string | null | undefined): string {
  if (!category) return 'task';
