...
export const strings = {
  ...
  info: {
    ...
    expenseSplitCustom: 'Enter custom amounts for each participant. The total must equal the expense amount.',
    expenseSplitPercentage: 'Enter percentages for each participant. The total must equal 100%.',
    groupCreation: 'You\'ll be automatically added as a member. Adding other members will be available soon!',
    accountCreation: 'This account will start with a balance of $0.00. Add transactions to track your finances!',
  },
};
